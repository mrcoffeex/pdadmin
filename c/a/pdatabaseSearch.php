<?php  
    ...
    include 'pdatabaseSearch.paginate.php';
    $title = "Phishing Database: " . $searchText;
?>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header text-capitalize"><i class="fas fa-database"></i> suspicious links and URLs <span class="float-right"><strong><?= countPhish($searchText) ?></strong> results</span></div>
                            <div class="card-body">
