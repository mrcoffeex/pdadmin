        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header text-capitalize"><i class="fas fa-copy"></i> recent reports <span class="float-right"><strong><?= countReports("") ?></strong> results</span></div>
                            <div class="card-body">
