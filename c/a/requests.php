  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><i class="nav-icon fas fa-copy"></i> Order Requests</h1>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-12">
            <form method="post" enctype="multipart/form-data" action="redirect">
              <div class="form-group">
                <input type="text" name="search_request" class="form-control" placeholder="search here ..." required autofocus>
              </div>
            </form>
          </div>
          <div class="col-md-12">
            <section class="content">
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title"><i class="fas fa-copy"></i> Order Requests <span class="badge badge-primary"><?= count_all_pending_requests(); ?></span></h3>
                ...
                <div class="card-body">
                  ...
                  <?php  
                    //get pending orders
                    $pending=$link->query("SELECT * From `um_order` Where `um_order_status`='order_confirm' OR `um_order_status`='processing'");
